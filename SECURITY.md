...
In scope: `duck.py` and its gates, the hook wiring for Claude Code and Codex, the
...
Out of scope: the limitations listed in [RISKS.md](RISKS.md), which are documented
