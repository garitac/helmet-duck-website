...
This folder is exactly what the plugin ships. The storefront, its infrastructure, the
watchers and the console live at the repository root; see [the repository README](../../README.md).
